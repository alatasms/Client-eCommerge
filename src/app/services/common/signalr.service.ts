...
//will open the signalR connection.
  start(hubUrl:string){
    ...
    this._connection?.onreconnected(connectionId=>console.log(`Reconnected - ConnectedID : ${connectionId}`));
    this._connection?.onreconnecting(error=>console.log("Reconnecting"));
    this._connection?.onclose(error=>console.log("Reconnection failed."))
  }
